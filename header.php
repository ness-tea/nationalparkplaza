...
<head>
    ...
    <!-- Javascripts needed for dynamic client-side functionality -->
    ...
    <script type="text/javascript" src="scripts/js/resultsMap.js"></script> 
    <script type="text/javascript" src="scripts/js/parkMap.js"></script>
</head>